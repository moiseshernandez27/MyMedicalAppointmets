...
public class UIMenu {
    ...
    public static final String[] MONTHS = {"January","February","March","April","May","June","July","August", "Septembre", "October", "November", "December"};
    ...
    private static void authUser(int userType){
        ...
        patients.add(new Patient("Moises Hernandez", "moises@mail.com"));
